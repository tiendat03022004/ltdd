...
import com.example.btck1.databinding.ActivityViewholderBrandBinding

class BrandAdapter(val items:MutableList<BrandModel>):
    RecyclerView.Adapter<BrandAdapter.Viewholder>() {

    // Biến để lưu trữ cộng và trừ
        //.
    private var selectedPosition=-1
    private var lastSelectedPosition=-1
    private lateinit var context: Context
    class Viewholder(val binding:ActivityViewholderBrandBinding):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Viewholder {
        ...
        val binding=ActivityViewholderBrandBinding.inflate(LayoutInflater.from(context),parent,false)
